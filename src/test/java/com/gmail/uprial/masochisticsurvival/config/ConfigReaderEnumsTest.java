...
import com.gmail.uprial.masochisticsurvival.helpers.TestEnum;
...
import static com.gmail.uprial.masochisticsurvival.config.ConfigReaderEnums.*;
...
public class ConfigReaderEnumsTest extends TestConfigBase {
    ...
    public void testWrongSetType() throws Exception {
        ...
        e.expectMessage("Invalid com.gmail.uprial.masochisticsurvival.helpers.TestEnum 'Z' in set at pos 0");
    ...
    public void testNotUniqueSet() throws Exception {
        e.expect(InvalidConfigException.class);
        e.expectMessage("com.gmail.uprial.masochisticsurvival.helpers.TestEnum 'A' in set is not unique");
    ...
    public void testWrongEnum() throws Exception {
        e.expect(InvalidConfigException.class);
        e.expectMessage("Invalid com.gmail.uprial.masochisticsurvival.helpers.TestEnum 'T' in enum");
